...
TAXONOMY: dict[str, Intent] = {
    ...
    "gaming.library": Intent(
        id="gaming.library",
        op="gaming_library",
        domain="gaming",
        description="Show installed or owned games library",
        signals=["my games", "game library", "games i own", "installed games",
                 "show my games", "steam library", "xbox games", "playstation games",
                 "epic games library", "nintendo library"],
        blockers=["gaming keyboard", "gaming mouse", "gaming chair", "gaming monitor",
                  "gaming headset", "gaming setup", "gaming pc"],
        extractor="generic",
        examples=["show my game library", "what games do I own",
                  "my Steam library", "installed games on Xbox"],
        slots={},
    ),

    "gaming.achievements": Intent(
        id="gaming.achievements",
        op="gaming_achievements",
        domain="gaming",
        description="View game achievements, trophies, or progress",
        signals=["achievements", "trophies", "gaming achievements", "my trophies",
                 "game progress", "unlocked achievements", "platinum trophy",
                 "gamerscore", "show achievements"],
        extractor="generic",
        examples=["show my achievements", "how many trophies do I have",
                  "my gamerscore", "unlocked achievements in Elden Ring"],
        slots={},
    ),

    "gaming.friends": Intent(
        id="gaming.friends",
        op="gaming_friends",
        domain="gaming",
        description="Show online gaming friends and their activity",
        signals=["gaming friends", "friends online", "who's online", "friends playing",
                 "online friends", "friend activity", "playing now", "game friends",
                 "psn friends", "xbox friends", "steam friends"],
        blockers=["my friends list", "add friend", "friend request"],
        extractor="generic",
        examples=["who's online right now", "show gaming friends",
                  "which friends are playing games"],
        slots={},
    ),

    "gaming.leaderboard": Intent(
        id="gaming.leaderboard",
        op="gaming_leaderboard",
        domain="gaming",
        description="Show leaderboard or rankings for a game",
        signals=["leaderboard", "game rankings", "top players", "global ranking",
                 "my rank", "game leaderboard", "ranked position", "world ranking"],
        extractor="generic",
        examples=["show the leaderboard", "what's my rank in Warzone",
                  "global top players"],
        slots={},
    ),
    ...
    "gaming.clips": Intent(
        ...
        op="gaming_clips",
        domain="gaming",
        description="View or share saved game clips and screenshots",
        signals=["game clips", "gaming clips", "saved clips", "game screenshots",
                 "capture gallery", "clips gallery", "my clips", "game highlights",
                 "xbox clips", "ps5 captures", "steam screenshots"],
        extractor="generic",
        examples=["show my game clips", "my saved clips", "gaming screenshots"],
        slots={},
    ),
    ...
    "arvr.launch": Intent(
        ...
        op="arvr_launch",
        domain="arvr",
        description="Launch an AR or VR app or experience",
        signals=["open vr", "launch vr", "start vr", "open ar", "launch ar",
                 "ar experience", "vr experience", "enter vr", "vr app",
                 "spatial app", "vision pro", "quest app", "mixed reality"],
        blockers=["ar rahman", "ar emoji", "avatar", "ar filter"],
        extractor="generic",
        examples=["launch the VR experience", "open spatial app",
                  "enter VR", "start AR navigation"],
        slots={},
    ),
    ...
    "arvr.space": Intent(
        ...
        op="arvr_space",
        domain="arvr",
        description="View or manage spatial spaces, rooms, or environments",
        signals=["spatial space", "vr room", "virtual space", "my spaces",
                 "spatial environment", "ar workspace", "virtual environment",
                 "mixed reality space", "create space", "virtual room"],
        extractor="generic",
        examples=["show my spaces", "create a virtual workspace",
                  "open my VR room"],
        slots={},
    ),

    "arvr.passthrough": Intent(
        id="arvr.passthrough",
        op="arvr_passthrough",
        domain="arvr",
        description="Toggle passthrough or mixed reality mode",
        signals=["passthrough", "mixed reality mode", "see through", "real world view",
                 "ar mode", "toggle passthrough", "turn on passthrough",
                 "look through headset"],
        extractor="generic",
        examples=["enable passthrough", "switch to mixed reality mode",
                  "toggle AR passthrough"],
        slots={},
    ),
    ...
    "arvr.status": Intent(
        ...
        op="arvr_status",
        domain="arvr",
        description="Check headset battery, connection, or device status",
        signals=["headset battery", "vr battery", "headset status", "quest battery",
                 "vision pro battery", "headset connection", "vr device status",
                 "headset charge"],
        extractor="generic",
        examples=["what's my headset battery", "Quest battery level",
                  "check VR headset status"],
        slots={},
    ),

    # ── Dating ─────────────────────────────────────────────────────────────────

    "dating.matches": Intent(
        id="dating.matches",
        op="dating_matches",
        domain="dating",
        description="Show new matches or match list from dating apps",
        signals=["my matches", "new matches", "dating matches", "tinder matches",
                 "hinge matches", "bumble matches", "show matches",
                 "who matched me", "dating app matches"],
        extractor="generic",
        examples=["show my matches", "any new matches on Hinge",
                  "my Tinder matches"],
        slots={},
    ),

    "dating.messages": Intent(
        id="dating.messages",
        op="dating_messages",
        domain="dating",
        description="View or reply to dating app messages",
        signals=["dating messages", "match messages", "message my match",
                 "reply to match", "hinge messages", "bumble message",
                 "tinder message", "dating chats", "message from match"],
        extractor="generic",
        examples=["show dating messages", "reply to my match",
                  "messages from Hinge"],
        slots={},
    ),
    ...
    "dating.profile": Intent(
        ...
        op="dating_profile",
        domain="dating",
        description="View or edit dating profile",
        signals=["dating profile", "my profile", "edit profile", "update bio",
                 "profile photos", "dating bio", "tinder profile", "hinge profile",
                 "bumble profile", "profile settings", "update my dating profile"],
        blockers=["linkedin profile", "facebook profile", "instagram profile",
                  "twitter profile", "social profile"],
        extractor="generic",
        examples=["show my dating profile", "edit my Hinge bio",
                  "update profile photos"],
        slots={},
    ),

    "dating.discover": Intent(
        id="dating.discover",
        op="dating_discover",
        domain="dating",
        description="Browse or discover people on dating apps",
        signals=["discover people", "browse matches", "swipe", "see who's nearby",
                 "dating discovery", "find matches", "who's around", "browse profiles",
                 "explore dating"],
        blockers=["discover music", "discover podcasts", "discover news"],
        extractor="generic",
        examples=["show me people nearby", "browse Hinge profiles",
                  "who's on Tinder near me"],
        slots={},
    ),
}
